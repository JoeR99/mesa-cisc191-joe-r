...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
	...
	private void createAndInitScrollingImage()
	{
		...
		b.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent evt)
			{
				 ...
				 */
				M23challJoeR.blackAndWhite(picture);
				repaint();
			}
		});
		...
		sunset.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent evt)
			{
				...
				try
				{
					...
					M23challJoeR.makeSunset(picture, r, gb);
				} catch (Exception e)
				{
		...
		mirrorV.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent evt)
			{
				 ...
				 * your provided solution.
				 */
				M23challJoeR.mirrorVertical(picture);
				repaint();
			}
		});
		...
		mirrorH.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent evt)
			{
				 ...
				 * your provided solution.
				 */
				M23challJoeR.mirrorHorizontal(picture);
				repaint();
			}
		});
	...
	{
		Picture pix = new Picture("images/beach.png");
		pix.explore();
